...
![#fig:6](/assets/images/historical_modelling/lorentzAtt.gif#center "Lorentz attractor for three different initial conditions")*Figure 6: Plot of a Lorentz attractor for three different initial conditions*

The three new solutions are represented by the colours orange, green, and red. Notice how despite starting at different locations on the plot and diverging from each other at different points, they all get attracted toward the two whirlpools. The analogy I would like to draw with historical events is the following. Much like how different events, decisions, environmental factors, etc., that lead to dire consequences yet similar in some sense (WWI and WWII), the Lorentz Attractor and other chaotic systems exhibit something similar.
